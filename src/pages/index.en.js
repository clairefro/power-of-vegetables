...
export default ({ data }) => {
  const [fart, setFart] = useState({
    play: () => console.log("can't play yet"),
  })
        ...
        <Fade>
          <div className="section-synopsis d-horizontal">
            <div className="deer-wrapper">
              <img
                src={imgBabydeer}
                alt="baby deer with open mouth"
                className="responsive mw-600"
                id="title-image"
              />
            </div>
            <div className="textbox textbox-constrained">
              <h2>Synopsis</h2>
              <p>
                Baby deer prefers sweet pecan pie over dirty vegetables - until
                Papa deer teaches the magical powers these veggies give us. But
                not all truths reveal themselves in the form of advice...
              </p>
              <h2 className="ta-center tilde">~</h2>
              <p>
                On the surface this book is a piece of propaganda to get
                children to eat their vegetables. More subtly, it encourages
                readers to question authority with their own observations. Most
                importantly this story reminds us to laugh in life - which is
                why it's best read aloud, not alone.
              </p>
            </div>
          </div>
        </Fade>
          ...
          <Fade>
            <div className="d-horizontal">
              ...
              <img
                src={imgBabydeerHead}
                className="responsive mw-600"
                alt="Baby deer looking at a butterly, which is seen reflected in his eye"
              />
            </div>
          </Fade>
          <Fade>
            <div className="d-horizontal reverse">
              <img
                src={imgRabbitToot}
                className="responsive mw-600"
                alt="Shocked rabbit tooting a rainbow while pausing eating a carrot"
              />
      ...
      <div className="container">
        <Fade>
          <div className="section-reviews">
            <img
              src={imgPapadeer}
              alt="Papa deer admiring his vegetable garden"
              className="responsive mw-600"
            />
            <h2>Reviews</h2>
            <div className="review">
              <span className="review-text">
                My son <strong>enjoyed the ending</strong> almost too much...{" "}
              </span>
              <p className="review-author">- Kendra B., mother of toddler</p>
            </div>
            <div className="review">
              <span className="review-text">
                Finally, a children's book where{" "}
                <strong>I laughed as loud as my kids did</strong>.
              </span>
            ...
            <div>
              <img
                ...
                alt="review by Kate, children's drawing of four family members reacting to the book with a postive note of thanks"
              />
          ...
          <div className="d-flex jc-center">
            <Link to="/books" className="btn large">
              Read now
            </Link>
          </div>
        </Fade>
